                ...
                <div class="jsv-backdrop">
                    <div class="jsv-backdrop-container">
                        <div class="jsv-backdrop-header">
                            ...
                            <div>
                                <img src="<?php echo plugins_url('admin/img/logo.webp', JSV360_MAIN_URL) ?>" class="jsv-logo" alt="360 Javascript Viewer">
                            </div>
                        </div>
                        ...
                        <div class="jsv-card">
                            <div class="jsv-px-4 jsv-pt-4">
                                <h1 class="jsv-typography-root jsv-typography-h1">
                                    <?=  __( '360 Product Rotations', 'jsv360') ?><br /><?=  __( 'WordPress and WooCommerce', 'jsv') ?>
                                </h1>
                                <h6 class="jsv-typography-root jsv-typography-h6 jsv-mt-4 jsv-mb-2">
                                    <?=  __('Official plugin for the 360° javascript viewer. <br>Create unlimited free 360° product presentations with all kind of options.', 'jsv') ?>
                                </h6>
                                <h6 class="jsv-typography-root jsv-typography-h6 jsv-mt-4 jsv-mb-2">
                                    <?=  __('How it works:', 'jsv') ?>
                                </h6>
                                <ul class="jsv-list-root pb-4 jsv-list-padding">
                                    <li class="jsv-list-item-root" style="max-width: 550px;">
                                        <div class="jsv-list-item-icon-root jsv-pr-3 jsv-mt-2">
                                            <svg class="jsv-svg-icon-root jsv-svg-icon-color" focusable="false" viewBox="0 0 24 24" aria-hidden="true">
                                        ...
                                        <div class="jsv-list-item-text-root jsv-d-flex jsv-flex-column jsv-m-0">
                                            <p class="jsv-typography-root jsv-body2" style="color: rgba(0, 0, 0, 0.6);">
                                                <?=  __('Use the <a href="https://www.360-javascriptviewer.com/wordpress?utm_source=wordpress&utm_medium=pluginhome&utm_campaign=3dweb" target="_blank"> online tool</a> to fine tune your 360 product presentation', 'jsv') ?>
                                            </p>
                                        </div>
                                    </li>
                                    <li class="jsv-list-item-root" style="max-width: 550px;">
                                        ...
                                        <div class="jsv-list-item-text-root jsv-d-flex jsv-flex-column jsv-m-0">
                                            <p class="jsv-typography-root jsv-body2" style="color: rgba(0, 0, 0, 0.6);">
                                                <?=  __('Copy/paste the code in a widget, on a page or in WooCommerce', 'jsv') ?>
                                            </p>
                                        </div>
                                    </li>
                                    <li class="jsv-list-item-root" style="max-width: 550px;">
                                        ...
                                        <div class="jsv-list-item-text-root jsv-d-flex jsv-flex-column jsv-m-0">
                                            <p class="jsv-typography-root jsv-body2" style="color: rgba(0, 0, 0, 0.6);">
                                                <?=  __('If you need other specific options check the <a href="https://wordpress.org/plugins/360deg-javascript-viewer/#installation" target="_blank">readme</a>. Like margins, floats and width', 'jsv') ?>
                                            </p>
                                        </div>
                                    </li>
                                ...
                                <span class="jsv-button-label" style="width: 100%;">
                                    <?=  __('Let\'s get started with your first presentation!', 'jsv') ?><span class="jsv-button-endIcon">
                                    <svg class="jsv-Svgicon-root" focusable="false" viewBox="0 0 24 24" aria-hidden="true">
